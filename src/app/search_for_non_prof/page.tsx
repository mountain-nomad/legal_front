...
export default function Component() {
    ...
    return (
        <div className="flex min-h-screen bg-gray-100 pt-16"> {/* Add top padding */}
            ...
            <div className="mt-8 flex flex-col items-center justify-center w-full ml-16 md:ml-64"> {/* Adjusted margin-left for main content */}
